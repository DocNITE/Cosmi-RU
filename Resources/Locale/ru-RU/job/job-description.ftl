...
job-description-brigmedic = Сражайтесь в тылу службы безопасности, за жизни своих товарищей! Вы первая и последняя надежда своего отряда. Гиппократ благословит тебя. В настоящее время недоступен.
